...
<body id="body">
  ...
  <div class="allowPage" id="allowPage">
    ...
    <!-- <form id="form1">
      <p id="selectMenuCount">あと7食必要です</p>
      <input class="choisedMenu" id="btn_submit" type="submit">
    </form> -->
    ...
    if (menuCountArrayStorage) {
      const valueCountFc = () => {
        ...
        Object.values(menuCountArrayStorage).forEach(value => {
          ...
          // key番目のクラスに対して配列にkeyが何個入っているかを検索
          const selectCount = document.getElementsByClassName('selectCount')[keyValue]
          selectCount.innerHTML = vallValue + "食"
